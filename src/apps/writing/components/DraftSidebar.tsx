...
export const DraftSidebar: React.FC<DraftSidebarProps> = ({
  ...
  return (
    <div className="w-full md:w-64 bg-black/40 border-b md:border-b-0 md:border-r border-white/10 flex flex-col shrink-0 max-h-60 md:max-h-none md:h-full min-h-0 overflow-hidden backdrop-blur-md">
      {/* Header & New CTA */}
      <div className="p-2.5 border-b border-white/10 space-y-2">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-2.5 py-1 bg-emerald-500 hover:bg-emerald-600 text-black text-[11px] font-bold rounded-lg flex items-center gap-1 shadow-sm transition-all active:scale-95"
          >
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-7 pr-2.5 py-1 rounded-lg bg-black/40 text-[11px] text-white placeholder-white/40 focus:outline-none focus:border-emerald-500 border border-white/10"
          />
        </div>
      </div>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <h4 className="text-xs font-bold truncate max-w-[170px] text-white">
