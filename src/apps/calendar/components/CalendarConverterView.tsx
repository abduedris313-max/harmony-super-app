    ...
    <div className="h-full overflow-y-auto p-4 md:p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-white/10">
        ...
        <button
          ...
          className="self-start sm:self-auto px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/15 text-xs text-white flex items-center gap-1.5 transition-colors"
        >
      ...
      <div className="p-4 rounded-2xl bg-white/[0.04] border border-white/10 space-y-4">
        ...
        {selectedSource === 'gregorian' && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div>
              <label className="text-[11px] text-neutral-400 block mb-1">Month</label>
              <select
                ...
                className="w-full bg-[#161b22] border border-neutral-700 rounded-lg px-3 py-2 text-xs text-white focus:outline-hidden focus:border-rose-500"
              >
            ...
            <div>
              <label className="text-[11px] text-neutral-400 block mb-1">Day</label>
              <input
                type="number"
            ...
            <div>
              <label className="text-[11px] text-neutral-400 block mb-1">Year (CE)</label>
              <input
                type="number"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full bg-[#161b22] border border-neutral-700 rounded-lg px-3 py-2 text-xs text-white focus:outline-hidden focus:border-emerald-500"
              >
            ...
            <div>
              <label className="text-[11px] text-neutral-400 block mb-1">Year (AH)</label>
              <input
                type="number"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full bg-[#161b22] border border-neutral-700 rounded-lg px-3 py-2 text-xs text-white focus:outline-hidden focus:border-amber-500"
              >
            ...
            <div>
              <label className="text-[11px] text-neutral-400 block mb-1">Year (EE)</label>
              <input
                type="number"
        ...
        <div className="text-[11px] text-neutral-400 flex items-center gap-3 pt-2">
          <span>
            Weekday: <strong className="text-white">{WEEKDAY_NAMES_EN[weekdayIndex]}</strong>
          </span>
          <span>•</span>
          <span>
            Arabic: <strong className="text-white">{WEEKDAY_NAMES_AR[weekdayIndex]}</strong>
          </span>
          <span>•</span>
          <span>
            Amharic: <strong className="text-white">{WEEKDAY_NAMES_AM[weekdayIndex]}</strong>
          </span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className={`p-4 rounded-2xl border transition-all ${
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              >
                {copiedKey === 'greg' ? <Check className="w-3.5 h-3.5 text-emerald-400" /> : <Copy className="w-3.5 h-3.5" />}
              </button>
            </div>
          ...
          <div className={`p-4 rounded-2xl border transition-all ${
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                title="Copy formatted date"
              >
                {copiedKey === 'eth' ? <Check className="w-3.5 h-3.5 text-amber-400" /> : <Copy className="w-3.5 h-3.5" />}
              </button>
            </div>
            <div className="text-lg font-bold text-white">
      ...
      <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/10 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
          <button
            ...
            className="p-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-left border border-white/5 transition-colors"
          >
            <div className="text-xs font-bold text-white">Enkutatash</div>
            <div className="text-[10px] text-amber-400">1 Meskerem (Eth. New Year)</div>
          </button>
          <button
            type="button"
            onClick={() => {
            ...
            className="p-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-left border border-white/5 transition-colors"
          >
            <div className="text-xs font-bold text-white">1st of Ramadan</div>
            <div className="text-[10px] text-emerald-400">1 Ramadan 1448 AH</div>
          </button>
          <button
            type="button"
            onClick={() => {
            ...
            className="p-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-left border border-white/5 transition-colors"
          >
            <div className="text-xs font-bold text-white">Eid al-Fitr</div>
            <div className="text-[10px] text-emerald-400">1 Shawwal 1448 AH</div>
          </button>
          <button
            type="button"
            onClick={() => {
            ...
            className="p-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-left border border-white/5 transition-colors"
          >
            <div className="text-xs font-bold text-white">Pagumē 1</div>
            <div className="text-[10px] text-amber-400">Ethiopian 13th Month</div>
          </button>
        </div>
      </div>
    </div>
